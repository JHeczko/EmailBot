...
class HelpWindow(QWidget):
    def __init__(self):
        ...
        help_przetwarzanie_tresc = QLabel('Aby zacząć przetwarzać należy najpierw wczytać plik, robi się to guzikiem <b>"Otwórz Plik"</b> znajduję się on w menu <b>Plik</b>. Następnie po otwarciu pliku w oknie wyświetlą się listy wraz z kolumnami. Należy wybrać dla każdej listy odpowiednią kolumnę. Na przykład dla listy z dopiskiem "Imie i Nazwisko Mamy", należy wybrać, kolumne tytuł kolumny, która odpowiada, kolumnie z odpowiednimi danymi. Można również wybrać odpowiednią opcję sformatowanych danych, czy w kolumnie mamy dane w formacie <b>IMIE-NAZWISKO</b>, czy <b>NAZWISKO-IMIE</b>, chodzi o to w jakiej kolejności ułożone są imiona, na przykład czy w tabeli z imionami mamy <b>"Katarzyna Nowak"</b> czy <b>"Nowak Katarzyna"</b>. Jeżeli istnieją więcej niż trzy kolumny z zaległościami, należy dodać nowe kolumny guzikiem <b>"Dodaj Okres"</b>, następnie z listy wybieramy sobie interesującą nasz kolumnę z zaległościami.')
